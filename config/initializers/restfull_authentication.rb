require 'restful-authentication/authentication'
require 'restful-authentication/authentication/by_password'
require 'restful-authentication/authentication/by_cookie_token'
...
REST_AUTH_SITE_KEY         = ENV['DATANEST_REST_AUTH_SITE_KEY']
