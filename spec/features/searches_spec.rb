...
describe 'Searches', sphinx: true do
  ...
  let!(:peter_student_record) { student_dataset.dataset_model.create!(name: 'Peter Black', address: 'Town at home', record_status: 'published') }
  let!(:lukas_student_record) { student_dataset.dataset_model.create!(name: 'Lukas Sweeter', address: 'Village', record_status: 'published') }
  let!(:tom_student_record) { student_dataset.dataset_model.create!(name: 'Tom', address: 'Street', record_status: 'published') }
  ...
  let!(:grammar_school_record) { school_dataset.dataset_model.create!(name: 'Grammar', record_status: 'published') }
