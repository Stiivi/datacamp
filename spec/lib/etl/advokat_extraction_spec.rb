  ...
  describe 'parsing' do
    ...
    it 'should get information from a document' do
      VCR.use_cassette('advokat_295627') do
        ...
        document = extractor.download
        advokat = extractor.digest(document)
        advokat.should == {:name=>"ADAMČÍK Andrej Mgr.", :avokat_type=>"Advokát", :street=>"Sedlárska 1", :city=>"Bratislava 1", :zip=>"811 01", :phone=>"02/3219 1153", :fax=>"02/3214 4888", :cell_phone=>"0917/611153", :languages=>"anglicky", :email=>"andrej.adamcik@hillbridges.com", :website=>nil, :url => "https://www.sak.sk/blox/cms/sk/sak/adv/vyhladanie/proxy/list/formular/rows/295627/link/display/event"}
      end
    end
    ...
    it 'should get information from a document' do
      VCR.use_cassette('advokat_19288') do
        ...
        document = extractor.download
        advokat = extractor.digest(document)
        advokat.should == {:name=>"BALAŽOVIČ Dušan JUDr.", :avokat_type=>"Advokát", :street=>"M.R.Štefánika 53", :city=>"NOVÉ ZÁMKY", :zip=>"940 01", :phone=>"", :fax=>"", :cell_phone=>"", :languages=>"", :email=>"", :website=>nil, :url => "https://www.sak.sk/blox/cms/sk/sak/adv/stop/proxy/list/formular/rows/19288/link/display/event"}
      end
    end
